// Microcomputer Systems lab06 Summer 2024
...
State currentState = INPUT; // the current state of the program

long timerStartTimeTicks;                // the time the timer was started in ticks
long timerTicksRemaining = 1 * 5 * 1000; // 6 minutes to seconds to ms. This default value doesnt actually matter other than for testing

int buffer[] = {
    0, 0, 0, 0}; // end of buffer
...
// flag to determine if a button is currently being pressed
...
void shiftIn(int value)
{
    ...
    switch (value)
    {
        case 0xA:
        {
            ...
            // interpret the left two digits as minutes
